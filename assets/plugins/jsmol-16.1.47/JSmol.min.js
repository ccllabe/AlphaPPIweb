...
!c&&alert("JSmolCore.js: synchronous binary file transfer is requested but not available"),a._syncBinaryOK=!1}return!0};a._binaryTypes="mmtf .gz .bz2 .jpg .gif .png .zip .jmol .bin .smol .spartan .pmb .mrc .map .ccp4 .dn6 .delphi .omap .pse .dcd .lut .uk/pdbe/densities/".split(" ");a.isBinaryUrl=function(c){for(var e=a._binaryTypes.length;0<=--e;)if(0<=c.indexOf(a._binaryTypes[e]))return!0;return!1};a._getFileData=function(c,e,h){var b=a.isBinaryUrl(c),d=0<=c.indexOf(".gz")&&0<=c.indexOf("rcsb.org");
...
c.html+"</div>"),d=new l.JSDialog,h=a._$(b),c.container=h,d.applet=c.manager.vwr.html5Applet,d.setContainer(h),d.dialog=c,d.setPosition(),d.dragBind(!0),h[0].jd=d);a.$bind("#"+c.id+" .JButton","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JComboBox","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JCheckBox","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JTextField","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+
c.id+" .JTable","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JScrollPane","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JEditorPane","mousedown touchstart",function(){d.ignoreMouse=!0})};l.setSelected=function(c){a.$prop(c.id,"checked",!!c.selected)};l.setSelectedIndex=function(c){a.$prop(c.id,"selectedIndex",c.selectedIndex)};l.setText=function(c){a.$prop(c.id,"value",c.text)};l.setVisible=function(c){a.$setVisible(c.id,c._visible)};l.setEnabled=
function(c){a.$setEnabled(c.id,c.enabled)};l.click=function(c,b){var h=l.htDialogs[c.id];if(h){var d=h.toString();if(0<=d.indexOf("JCheck"))h.selected=c.checked;else if(0<=d.indexOf("JCombo"))h.selectedIndex=c.selectedIndex;else if(null!=h.text&&(h.text=c.value,b&&13!=(b.charCode||b.keyCode)))return}d=l.htDialogs[a.$getAncestorDiv(c.id,"JDialog").id];d.manager.actionPerformed(h?h.name:d.registryKey+"/"+c.id)};l.setFront=function(c){var b=c.manager.vwr.html5Applet;c.zIndex!=a._getZ(b,"dialog")&&(c.zIndex=
a._incrZ(b,"dialog"));c.container&&((c.container[0]||c.container).style.zIndex=c.zIndex)};l.hideMenus=function(a){if(a=a._menus)for(var b in a)a[b]._visible&&l.hideMenu(a[b])};l.windowClosing=function(c){c=l.htDialogs[a.$getAncestorDiv(c.id,"JDialog").id];c.registryKey?c.manager.processWindowClosing(c.registryKey):c.dispose()};a._track=function(c){if(a._tracker){try{var b='<iframe style="display:none" width="0" height="0" frameborder="0" tabindex="-1" src="'+(a._tracker+"&applet="+c._jmolType+"&version="+
a._version+"&appver="+a.___JmolVersion+"&url="+encodeURIComponent(document.location.href))+'"></iframe>';a.$after("body",b)}catch(h){}delete a._tracker}return c};var m;a.getProfile=function(a){if(self.Clazz&&self.JSON)return m||Clazz._startProfiling(m=0==arguments.length||a),Clazz.getProfile()};a._getInChIKey=function(a,b){0<=b.indexOf("MOL=")&&b.split("MOL=")[1].split('"')};a._getAttr=function(a,b){var h=a.indexOf(b+"=");return 0<=h&&0<=(h=a.indexOf('"',h))?a.substring(h+1,a.indexOf('"',h+1)):null};
a.User={viewUpdatedCallback:null};a.View={count:0,applets:{},sets:{}};(function(b){b.resetView=function(b,c){debugger;if(c){if(c._viewSet){var d=a.View.applets[c._viewSet];for(b in d)b!=c&&a.View.resetView(b)}}else b&&(b._reset(),a.View.updateView(b))};b.updateView=function(e,d){if(null!=e._viewSet){d||(d={});d.chemID||(e._searchQuery=null);d.data||(d.data="N/A");d.type=e._viewType;if(null==(e._currentView=b.__findView(e._viewSet,d)))e._currentView=b.__createViewSet(e._viewSet,d.chemID,d.viewID||
d.chemID);e._currentView[d.type].data=d.data;e._currentView[d.type].smiles=e._getSmiles();a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(e,"updateView");b.__setView(e._currentView,e,!1)}};b.updateFromSync=function(e,d){e._updateMsg=d;var f=a._getAttr(d,"sourceID")||a._getAttr(d,"file");if(f){var g=b.__findView(e._viewSet,{viewID:f});if(null==g)return a.updateView(e,d);g!=e._currentView&&b.__setView(g,e,!0);var k=(f=a._getAttr(d,"atoms"))&&0<=d.indexOf("selectionhalos ON")?eval("["+f+"]"):
[];setTimeout(function(){e._currentView==g&&b.updateAtomPick(e,k)},10);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(e,"updateFromSync")}};b.updateAtomPick=function(b,c){var d=b._currentView;if(null!=d){for(var f in d)"info"!=f&&d[f].applet!=b&&d[f].applet._updateAtomPick(c);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(b,"updateAtomPick")}};b.dumpViews=function(a){var d=b.sets[a];if(d){var f="View set "+a+":\n";a=b.applets[a];for(var g in a)f+="\napplet "+a[g]._id+" currentView="+
(a[g]._currentView?a[g]._currentView.info.viewID:null);for(g=d.length;0<=--g;){a=d[g];var f=f+("\n\n<b>view="+g+" viewID="+a.info.viewID+" chemID="+a.info.chemID+"</b>\n"),k,j;for(j in a)"info"!=j&&(f+="\nview="+g+" type="+j+" applet="+((k=a[j]).applet?k.applet._id:null)+" SMILES="+k.smiles+"\n atomMap="+JSON.stringify(k.atomMap)+"\n data=\n"+k.data+"\n")}return f}};b.__init=function(a){var d=a._viewSet,f=b.applets;f[d]||(f[d]={});f[d][a._viewType]=a};b.__findView=function(a,d){var f=b.sets[a];null==
f&&(f=b.sets[a]=[]);for(var g=f.length;0<=--g;){var k=f[g];if(d.viewID){if(k.info.viewID==d.viewID)return k}else{if(null!=d.chemID&&d.chemID==k.info.chemID)return k;for(var j in k)if("info"!=j&&(null!=d.data&&null!=k[j].data?d.data==k[j].data:d.type==j))return k}}return null};b.__createViewSet=function(e,d,f){b.count++;d={info:{chemID:d,viewID:f||"model_"+b.count}};for(var g in a._applets)f=a._applets[g],f._viewSet==e&&(d[f._viewType]={applet:f,data:null});b.sets[e].push(d);return d};b.__setView=
function(a,b,c){for(var d in a)if("info"!=d){var f=a[d],g=f.applet,k=c||null!=g&&"<modified>"==g._molData;if(!(null==g||g==b&&!k)){var j=null==f.data,l=null!=g._currentView;g._currentView=a;if(!l||!(a[d].data==f.data&&!j&!k))if(g._loadModelFromView(a),j)break}}}})(a.View);a.Cache={fileCache:{}};a.Cache.get=function(b){return a.Cache.fileCache[b]};a.Cache.put=function(b,e){a.Cache.fileCache[b]=e};a.Cache.setDragDrop=function(b,e){a.$appEvent(b,e,"dragover",function(a){a=a.originalEvent;a.stopPropagation();
...
e)k=String.instantialize(f),a.$(b,e).val(0>k.indexOf("\x00")?k:f.length+" bytes");else{k.endsWith(".spt")||b._appletPanel.cacheFileByName("cache://DROP_*",!1);"JSV"==b._viewType||k.endsWith(".jdx")?a.Cache.put(k,f):b._appletPanel.cachePut(k,f);f=a._jsGetXY(b._canvas,d);var j=[null];f&&(!b._appletPanel.setStatusDragDropped||b._appletPanel.setStatusDragDropped(0,f[0],f[1],k,j))&&b._appletPanel.openFileAsyncSpecialType(k,1,j[0])}}},f.readAsArrayBuffer(g)})}})(Jmol,jQuery);
...
g)return"";a._debugAlert&&alert(g);return a._documentWrite(g)};j._getRadioGroup=function(g,d,b,f,k,l){var m=typeof d;if("object"!=m||null==m||!d.length)alert("invalid arrayOfRadioButtons");else{void 0!=b&&null!=b||(b="&#xa0; ");var c=d.length;++j._radioGroupCount;f||(f="jmolRadioGroup"+(j._radioGroupCount-1));for(var e="<span id='"+(k?k:f)+"'>",h=0;h<c;++h){h==c-1&&(b="");var s=d[h],m=typeof s,M=null,e="object"==m?e+(M=j._radio(g,s[0],s[1],s[2],b,f,3<s.length?s[3]:(k?k:f)+"_"+h,4<s.length?s[4]:0,
l)):e+(M=j._radio(g,s,null,null,b,f,(k?k:f)+"_"+h,l));if(null==M)return""}e+="</span>";a._debugAlert&&alert(e);return a._documentWrite(e)}}})(Jmol);
...
a.allClasses={};a.isClassDefined=a.isDefinedClass=function(b){if(!b)return!1;var c=a._getDeclared(b);if(!c){for(var d=b.split(/\./),c=null,e=0;e<d.length;e++)if(!(c=c?c[d[e]]:a.allPackage[d[0]]))return!1;a._setDeclared(b,c)}return c};a._setDeclared=function(b,c){a.allClasses[b]=c;0>b.indexOf(".")&&(a.allClasses["java.lang."+b]=c)};a._getDeclared=function(b){var c=a.allClasses[b];!c&&0>b.indexOf(".")&&(c=a.allClasses["java.lang."+b]);return c};a.instanceOf=function(b,c){if(null==b)return!1;"string"==
typeof c&&(c=a.isClassDefined(c));return!c?!1:c==String?"string"==typeof b:null!=b&&c&&(b==c||b instanceof c||0<=a.getInheritedLevel(a.getClassName(b),c))};a.superCall=function(b,c,d,e){var f=null,g=-1,h=b[d];if(h)if(h.claxxOwner)h.claxxOwner!==c&&(f=h);else if(!h.stacks&&(!h.lastClaxxRef||!h.lastClaxxRef.prototype[d]||!h.lastClaxxRef.prototype[d].stacks))f=h;else{var j=h.stacks;j||(j=h.lastClaxxRef.prototype[d].stacks);for(g=j.length;0<=--g;)if(c===j[g]){f=0<g?j[--g].prototype[d]:j[0].prototype[d]["\\unknown"];
break}else if(0<a.getInheritedLevel(c,j[g])){f=j[g].prototype[d];break}}if(f)return 0==g&&"construct"==d&&(c=h.stacks)&&(!c[0].superClazz&&c[0].con$truct)&&c[0].con$truct.apply(b,[]),f.apply(b,e||[]);"construct"!=d&&(a.alert(["j2slib","no class found",e.typeString]),V(b,c,d,a.getParamsType(e).typeString))};a.superConstructor=function(b,c,d){a.superCall(b,c,"construct",d);c.con$truct&&c.con$truct.apply(b,[])};a.CastedNull=function(b){this.clazzName=b?b instanceof String?b:b instanceof Function?a.getClassName(b,
!0):""+b:"Object";this.toString=function(){return null};this.valueOf=function(){return null}};a.castNullAs=function(b){return new a.CastedNull(b)};a._initializingException=!1;a._callingStackTraces=[];var c=function(){this.toString=function(){return"J2S MethodException"}},e;try{null.hello()}catch(h){if(f=function(a,b,c){c||(c="[^\\s]+");var d=a.indexOf(b);a=a.substring(0,d)+c+a.substring(d+b.length);return RegExp("^"+a+"$")},/Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)){var f=h.message.indexOf(":"),
s=h.message.indexOf(":",f+2),M=h.message.substr(f+1,s-f-20);e=function(a){return-1!=a.message.indexOf(M)}}else if(-1!=navigator.userAgent.toLowerCase().indexOf("webkit")){var O=f(h.message,"hello");e=function(a){return O.test(a.message)}}else O=f(h.message,"$$o$$"),e=function(a){return O.test(a.message)}}a.exceptionOf=function(b,c){if(b.__CLASS_NAME__)return a.instanceOf(b,c);b.getMessage||(b.getMessage=function(){return""+b+(b.stack?"\n"+b.stack:"")});b.printStackTrace||(b.printStackTrace=function(){System.err.println(""+
b)});if(c==Error){if(0>(""+b).indexOf("Error"))return!1;System.out.println(a.getStackTrace());return!0}return c==Exception||c==Throwable||c==NullPointerException&&e(b)};a.getStackTrace=function(a){a||(a=25);var b="\n",c=arguments.callee,d=0>a;d&&(a=-a);try{for(var e=0;e<a&&(c=c.caller);e++){var f=c.toString?c.toString().substring(0,c.toString().indexOf("{")):"<native method>",b=b+(e+" "+(c.exName?(c.claxxOwner?c.claxxOwner.__CLASS_NAME__+".":"")+c.exName+f.replace(/function /,""):f)+"\n");if(c==c.caller){b+=
"<recursing>\n";break}if(d)for(var g=c.arguments,h=0;h<g.length;h++){var j=""+g[h];60<j.length&&(j=j.substring(0,60)+"...");b+=" args["+h+"]="+j.replace(/\s+/g," ")+"\n"}}}catch(k){}return b};a.makeConstructor=function(b,c,d){a.defineMethod(b,"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.overrideConstructor=function(b,c,d){a.overrideMethod(b,"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.defineMethod=function(d,e,f,g){f.exName=e;g=U(g);
var h=d.prototype,j=h[e];a._Loader._checkLoad&&S(d,e,g);if(!j||j.claxxOwner===d&&j.funParams==g)return f.funParams=g,f.claxxOwner=d,f.exClazz=d,h[e]=f;var k=null,l=j.stacks;l||(l=[],k=j,j.claxxOwner&&(l[0]=k.claxxOwner));if(!j.stacks||j.claxxReference!==d){++r;j=function(){var d;a:{var e=arguments.callee.claxxReference,A=arguments.callee.methodName;d=arguments;fx=this[A];var f=a.getParamsType(d);if(!fx)try{System.out.println(a.getStackTrace(5))}catch(g){}if(b){var E=e.__CLASS_NAME__+" "+A+" ";0>u.indexOf(E)&&
(u+=E+"\n");b[E]||(b[E]=0);b[E]++}if(fx.lastParams==f.typeString&&fx.lastClaxxRef===e){if(f.hasCastedNull){e=[];for(A=0;A<d.length;A++)e[A]=d[A]instanceof a.CastedNull?null:d[A]}else e=d;d=fx.lastMethod?fx.lastMethod.apply(this,e):null}else{fx.lastParams=f.typeString;fx.lastClaxxRef=e;E=fx.stacks;E||(E=e.prototype[A].stacks);for(var h=!1,j=E.length;0<=--j;)if(h||E[j]===e){var t=E[j].prototype[A],k=f,h=d,va=fx,l=[],H=!0,m=void 0;for(m in t)if(92==m.charCodeAt(0)){var B=m.substring(1).split("\\");B.length==
k.length&&l.push(B);H=!1}else if(H&&"funParams"==m&&t.funParams){m=t.funParams;B=m.substring(1).split("\\");B.length==k.length&&(l[0]=B);break}if(!(m=0==l.length)){for(var m=k,B=[],n=l.length,F=0;F<n;F++){for(var p=[],sa=!0,s=l[F].length,r=0;r<s;r++)if(p[r]=a.getInheritedLevel(m[r],l[F][r]),0>p[r]){sa=!1;break}sa&&(p[m.length]=F,B.push(p))}if(0==B.length)l=null;else{n=B[0];for(F=1;F<B.length;F++){p=!0;for(r=0;r<m.length;r++)if(n[r]<B[F][r]){p=!1;break}p&&(n=B[F])}l=l[n[m.length]].join("\\")}m=!l}if(m)h=
new c;else{t=H?t:t["\\"+l];H=null;if(k.hasCastedNull){H=[];for(k=0;k<h.length;k++)H[k]=h[k]instanceof a.CastedNull?null:h[k]}else H=h;va.lastMethod=t;h=t.apply(this,H)}if(!(h instanceof c)){d=h;break a}h=!0}"construct"!=A&&V(this,e,A,f.typeString);d=void 0}}return d};j.methodName=e;j.claxxReference=d;j=h[e]=j;e=[];for(h=0;h<l.length;h++)e[h]=l[h];j.stacks=e}l=j.stacks;0>T(l,d)&&l.push(d);k&&(k.claxxOwner===d?(j[k.funParams]=k,k.claxxOwner=null,k.funParams=null):k.claxxOwner||(j["\\unknown"]=k));f.exClazz=
d;j[g]=f;return j};duplicatedMethods={};var S=function(b,c,d){var e=b.prototype[c];if(e&&(e.claxxOwner||e.claxxReference)===b)key=b.__CLASS_NAME__+"."+c+d,(b=duplicatedMethods[key])?(c="Warning! Duplicate method found for "+key,System.out.println(c),a.alert(c),duplicatedMethods[key]=b+1):duplicatedMethods[key]=1};a.showDuplicates=function(a){var b="",c=duplicatedMethods,d=0,e;for(e in c)1<c[e]&&(b+=c[e]+"\t"+e+"\n",d++);b="Duplicates: "+d+"\n\n"+b;System.out.println(b);a||alert(b)};var T=function(a,
b){if(a&&b)for(var c=a.length;0<=--c;)if(a[c]===b)return c;return-1},ka=function(a,b){var c=T(a,b);if(0<=c){for(var d=a.length-1;c<d;c++)a[c]=a[c+1];a.length--;return!0}},U=function(a){return a?a.replace(/~([NABSO])/g,function(a,b){switch(b){case "N":return"n";case "B":return"b";case "S":return"String";case "O":return"Object";case "A":return"Array"}return"Unknown"}).replace(/\s+/g,"").replace(/^|,/g,"\\").replace(/\$/g,"org.eclipse.s"):"\\void"};a.overrideMethod=function(b,c,d,e){d.exName=c;e=U(e);
a._Loader._checkLoad&&S(b,c,e);d.funParams=e;d.claxxOwner=b;return b.prototype[c]=d};var u="";a.getProfile=function(){var a="";if(b){var a=[],c;for(c in b){var d=""+b[c];a.push("        ".substring(d.length)+d+"\t"+c)}a=a.sort().reverse().join("\r\n");b={}}return a};a.getParamsType=function(b){var c=b.length;switch(c){case 0:var d=["void"];d.typeString="\\void";return d;case 1:switch(typeof obj){case "number":return d=["n"],d.typeString="\\n",d;case "boolean":return d=["b"],d.typeString="\\b",d}}d=
[];d.hasCastedNull=!1;if(b)for(var e=0;e<c;e++)d[e]=a.getClassName(b[e]),b[e]instanceof a.CastedNull&&(d.hasCastedNull=!0);d.typeString="\\"+d.join("\\");return d};var r=0;a.allPackage={};a.lastPackageName=null;a.lastPackage=null;a.unloadedClasses=[];a.declarePackage=function(b){if(a.lastPackageName==b)return a.lastPackage;if(b&&b.length){for(var c=b.split(/\./),d=a.allPackage,e=0;e<c.length;e++)d[c[e]]||(d[c[e]]={__PKG_NAME__:d.__PKG_NAME__?d.__PKG_NAME__+"."+c[e]:c[e]},0==e&&a.setGlobal(c[e],d[c[e]])),
d=d[c[e]];a.lastPackageName=b;return a.lastPackage=d}};a.evalType=function(b,c){var d=b.lastIndexOf(".");if(-1!=d){var e=b.substring(0,d),e=a.declarePackage(e),d=b.substring(d+1);return e[d]}if(c)return window[b];switch(b){case "string":return String;case "number":return Number;case "object":return a._O;case "boolean":return Boolean;case "function":return Function;case "void":case "undefined":case "unknown":return b;case "NullObject":return NullObject;default:return window[b]}};a.defineType=function(b,
c,d,e){var f=a.unloadedClasses[b];f&&(c=f);f=b.lastIndexOf(".");if(-1!=f){var g=b.substring(0,f),g=a.declarePackage(g),f=b.substring(f+1);if(g[f])return g[f];g[f]=c}else{if(window[b])return window[b];a.setGlobal(b,c)}a.decorateAsType(c,b,d,e);b=a._innerFunctions;c.defineMethod=b.defineMethod;c.defineStaticMethod=b.defineStaticMethod;c.makeConstructor=b.makeConstructor;return c};var X=!1;-1!=navigator.userAgent.indexOf("Safari")&&(f=navigator.userAgent,s=f.indexOf("Version/"),-1!=s&&(f=f.substring(s+
8),X=4<=parseFloat(f)));a.instantialize=function(a,b){if(!b||!(1==b.length&&b[0]&&b[0]instanceof l)){a instanceof Number&&(a.valueOf=function(){return this});if(X){for(var c=[],d=0;d<b.length;d++)c[d]=b[d];b=c}(c=a.construct)?a.con$truct?a.getClass().superClazz?c.claxxOwner&&c.claxxOwner===a.getClass()||c.stacks&&c.stacks[c.stacks.length-1]==a.getClass()?c.apply(a,b):(c.claxxOwner&&!c.claxxOwner.superClazz&&c.claxxOwner.con$truct?c.claxxOwner.con$truct.apply(a,[]):c.stacks&&(1==c.stacks.length&&!c.stacks[0].superClazz)&&
c.stacks[0].con$truct.apply(a,[]),c.apply(a,b),a.con$truct.apply(a,[])):(a.con$truct.apply(a,[]),c.apply(a,b)):c.apply(a,b):a.con$truct&&a.con$truct.apply(a,[])}};a.innerFunctionNames="isInstance equals hashCode getName getCanonicalName getClassLoader getResource getResourceAsStream defineMethod defineStaticMethod makeConstructor".split(" ");a._innerFunctions={isInstance:function(b){return a.instanceOf(b,this)},equals:function(a){return this===a},hashCode:function(){return this.getName().hashCode()},
...
a.declareInterface(java.util,"Comparator");java.lang.ClassLoader={__CLASS_NAME__:"ClassLoader"};var V=function(b,c,d,e){b="";e&&(b=e.substring(1).replace(/\\/g,","));c=(d&&"construct"!=d?"Method":"Constructor")+" "+a.getClassName(c,!0)+"."+d+"("+b+") is not found!";throw new java.lang.NoSuchMethodException(c);};a.prepareCallback=function(b,c){var d=c[0];if(b&&d&&d!==window){var e=a.getClassName(d,!0),f={};if(b.b$)for(var g in b.b$)f[g]=b.b$[g];b.b$=f;f[e]=d;for(e=a.getClass(d);e.superClazz;)e=e.superClazz,
f[a.getClassName(e,!0)]=d;if(d=d.b$)for(g in d)f[g]=d[g]}for(f=0;f<c.length-1;f++)c[f]=c[f+1];0<c.length&&c.length--};a.innerTypeInstance=function(b,c,d){b||(b=arguments.callee.caller);var e;if(d||c.$finals)if(e=new b(c,a.inheritArgs),d)if(c.f$){var f={},g;for(g in c.f$)f[g]=c.f$[g];for(g in d)f[g]=d[g];e.f$=f}else e.f$=d;else c.f$&&(e.f$=c.f$);else switch(arguments.length){case 3:return new b(c);case 4:return c.__CLASS_NAME__==b.__CLASS_NAME__&&arguments[3]===a.inheritArgs?c:new b(c,arguments[3]);
...
a.inheritArgs)}g=arguments.length-3;for(f=Array(g);0<=--g;)f[g]=arguments[g+3];a.instantialize(e,f);return e};a.cloneFinals=function(){for(var a={},b=arguments.length/2;0<=--b;)a[arguments[b+b]]=arguments[b+b+1];return a};a.defineEnumConstant=function(a,b,c,d,e){e=e?new e:new a;e.$name=b;e.$ordinal=c;d&&d.length&&e.construct.apply(e,d);a[b]=e;a.prototype[b]=e;a["$ values"]||(a["$ values"]=[],a.values=function(){return this["$ values"]});a["$ values"].push(e);return e};a.floatToInt=function(a){return isNaN(a)?
0:0>a?Math.ceil(a):Math.floor(a)};a.floatToByte=a.floatToShort=a.floatToLong=a.floatToInt;a.doubleToByte=a.doubleToShort=a.doubleToLong=a.doubleToInt=a.floatToInt;a.floatToChar=function(a){return String.fromCharCode(0>a?Math.ceil(a):Math.floor(a))};a.doubleToChar=a.floatToChar;var aa=function(a,b){a||(a=0);if("object"==typeof a)var c=a;else for(var c=Array(a),d=0;d<a;d++)c[d]=0;c.BYTES_PER_ELEMENT=b>>3;c._fake=!0;return c},P=function(a,b){a||(a=0);b||(b=this.length);if(this._fake){var c=new this.constructor(b-
a);System.arraycopy(this,a,c,0,b-a);return c}return new this.constructor(this.buffer.slice(a*this.BYTES_PER_ELEMENT,b*this.BYTES_PER_ELEMENT))};!0==(a.haveInt32=!!(self.Int32Array&&self.Int32Array!=Array))?Int32Array.prototype.sort||(Int32Array.prototype.sort=Array.prototype.sort):(Int32Array=function(a){return aa(a,32)},Int32Array.prototype.sort=Array.prototype.sort,Int32Array.prototype.toString=function(){return"[object Int32Array]"});Int32Array.prototype.slice||(Int32Array.prototype.slice=function(){return P.apply(this,
arguments)});Int32Array.prototype.clone=function(){var a=this.slice();a.BYTES_PER_ELEMENT=4;return a};!0==(a.haveFloat64=!!(self.Float64Array&&self.Float64Array!=Array))?Float64Array.prototype.sort||(Float64Array.prototype.sort=Array.prototype.sort):(Float64Array=function(a){return aa(a,64)},Float64Array.prototype.sort=Array.prototype.sort,Float64Array.prototype.toString=function(){return"[object Float64Array]"});Float64Array.prototype.slice||(Float64Array.prototype.slice=function(){return P.apply(this,
arguments)});Float64Array.prototype.clone=function(){return this.slice()};a.newArray=function(a,b,c,d){if(-1!=a||2==arguments.length)return K(arguments,0);a=b.slice(c,d);a.BYTES_PER_ELEMENT=b.BYTES_PER_ELEMENT;return a};var K=function(a,b){var c=a[0];"string"==typeof c&&(c=c.charCodeAt(0));var d=a.length-1,e=a[d];if(1<d){for(var e=Array(d),f=0;f<d;f++)e[f]=a[f+1];d=Array(c);for(f=0;f<c;f++)d[f]=K(e,b);return d}0<b&&0>c&&(c=e);switch(b){case 8:return d=new Int8Array(c),d.BYTES_PER_ELEMENT=1,d;case 32:return d=
new Int32Array(c),d.BYTES_PER_ELEMENT=4,d;case 64:return d=new Float64Array(c),d.BYTES_PER_ELEMENT=8,d;default:d=0>c?e:Array(c);d.BYTES_PER_ELEMENT=0;if(0<c&&null!=e)for(f=c;0<=--f;)d[f]=e;return d}};a.newByteArray=function(){return K(arguments,8)};a.newIntArray=function(){return K(arguments,32)};a.newFloatArray=function(){return K(arguments,64)};a.newDoubleArray=a.newFloatArray;a.newLongArray=a.newShortArray=a.newIntArray;a.newCharArray=a.newBooleanArray=a.newArray;!0==(a.haveInt8=!!self.Int8Array)?
(Int8Array.prototype.sort||(Int8Array.prototype.sort=Array.prototype.sort),Int8Array.prototype.slice||(Int8Array.prototype.slice=function(){return P.apply(this,arguments)})):a.newByteArray=a.newIntArray;Int8Array.prototype.clone=function(){var a=this.slice();a.BYTES_PER_ELEMENT=1;return a};a.isAB=function(a){return a&&"object"==typeof a&&1==a.BYTES_PER_ELEMENT};a.isAI=function(a){return a&&"object"==typeof a&&4==a.BYTES_PER_ELEMENT};a.isAF=function(a){return a&&"object"==typeof a&&8==a.BYTES_PER_ELEMENT};
...
"JU.P3"==a.getClassName(b[0])};a.defineStatics=function(a){for(var b=arguments.length,c=(b-1)/2;0<=--c;){var d=arguments[--b],e=arguments[--b];a[e]=a.prototype[e]=d}};a.prepareFields=function(a,b){var c=[];if(a.con$truct)for(var d=a.con$truct.stacks,e=0;e<d.length;e++)c[e]=d[e];d=a.con$truct=function(){var a=arguments.callee.stacks;if(a)for(var b=0;b<a.length;b++)a[b].apply(this,[])};a.prototype.con$truct=d;c.push(b);a.con$truct.stacks=c;a.con$truct.index=0};a.checkPrivateMethod=function(){me=arguments.callee.caller;
...
-1!=k)){var p=9;try{p=parseFloat(h.subString(k+6))}catch(s){}9.6<=p&&(g=6)}var u;self.Clazz&&a.isClassDefined?isClassDefined=a.isClassDefined:(u={},isClassDefined=function(a){return!0==u[a]});var v=function(a){if(!a||0==a.length)return[];for(var b=null,c=0;c<a.length;c++)if(a[c]){if("$"==a[c].charAt(0))if("."==a[c].charAt(1)){if(!b)continue;var d=b.lastIndexOf(".");-1!=d&&(b=b.substring(0,d),a[c]=b+a[c].substring(1))}else a[c]="org.eclipse.s"+a[c].substring(1);b=a[c]}return a},w=[],C={},y=0;b.loadPackageClasspath=
function(a,c,d,e,f,g){f||(f=0);e||(e=null);g||(g=0);var h=d&&C["@"+a];if(0==f&&(d&&!C["@java"]&&0!=a.indexOf("java")&&null!=window["java.registered"]&&!C["@java"])&&(b.loadPackage("java",e?function(){b.loadPackageClasspath(a,c,d,e,1)}:null),e))return;if(a instanceof Array)if(v(a),e)g<a.length?b.loadPackageClasspath(a[g],c,d,function(){b.loadPackageClasspath(a,c,d,e,1,g+1)},1):e();else for(f=0;f<a.length;f++)b.loadPackageClasspath(a[f],c,d,null);else{switch(a){case "java.*":a="java";case "java":break;
default:a.lastIndexOf(".*")==a.length-2&&(a=a.substring(0,a.length-2))}c&&(C["@"+a]=c);d&&!h&&!window[a+".registered"]?(y++,"java"==a&&(a="core"),b.loadClass(a+".package",function(){0==--y&&ta()},!0,!0,1)):e&&e()}};a.loadClass=function(c,d,e){self.Class||(Class=a,Class.forName=a._4Name,JavaObject=a._O);return c&&b.loadClass(c,d,!0,e,1)};b.loadClass=function(c,f,g,h,j){j||(j=0);null==h&&(h=!1);if("boolean"==typeof f)return a.evalType(c);null!=window["java.registered"]&&!C["@java"]&&b.loadPackage("java");
b.keepOnLoading=!0;if(!g&&(y&&c.lastIndexOf(".package")!=c.length-8||0!=c.indexOf("java.")&&!isClassDefined(la)))ma.push([c,f]);else if((j=isClassDefined(c))||z["@"+c]){if(j&&f&&(g=D(c),!g||g.status>=n.STATUS_LOAD_COMPLETE))h?window.setTimeout(f,25):f()}else{var k=b.getClasspathFor(c);j=e[k];if(!j)for(h=w.length;0<=--h;)if(w[h].path==k||w[h].name==c){j=!0;break}if(j){if(f&&(j=D(c)))if(j.onLoaded){if(f!=j.onLoaded){var l=j.onLoaded,m=f;j.onLoaded=function(){l();m()}}}else j.onLoaded=f}else{j=a.unloadedClasses[c]&&
D(c)||new n;j.name=c;j.path=k;j.isPackage=k.lastIndexOf("package.js")==k.length-10;fa(k,c,j);j.onLoaded=f;j.status=n.STATUS_KNOWN;c=!1;for(h=w.length;0<=--h;)if(w[h].status!=n.STATUS_LOAD_COMPLETE){c=!0;break}if(j.isPackage){for(h=w.length;0<=--h&&!w[h].isPackage;)w[h+1]=w[h];w[++h]=j}else c&&w.push(j);if(!c){var t=!1;f&&(t=I,I=!0);g&&(f=null);ba(d,j,!0);G(j,j.path,j.requiredBy,!1,f?function(){I=t;f()}:null)}}}};b.loadPackage=function(a,c){c||(c=null);window[a+".registered"]=!1;b.loadPackageClasspath(a,
b.J2SLibBase||(b.J2SLibBase=b.getJ2SLibBase()||"j2s/"),!0,c)};b.jarClasspath=function(a,b){b instanceof Array||(b=[b]);v(b);j._debugCore&&(a=a.replace(/\.z\./,"."));for(var c=b.length;0<=--c;)C["#"+b[c]]=a;C["$"+a]=b};b.registerPackages=function(c,d){for(var e=b.getClasspathFor(c+".*",!0),f=0;f<d.length;f++)window.Clazz&&a.declarePackage(c+"."+d[f]),b.loadPackageClasspath(c+"."+d[f],e)};b.getClasspathFor=function(c,d,e){var f=C["#"+c];if(!f||d||e){var g,h;if(f){if(c=c.replace(/\./g,"/"),0<=(h=f.lastIndexOf(c))||
0<=(h=c.lastIndexOf("/"))&&0<=(h=f.lastIndexOf(c.substring(0,h))))g=f.substring(0,h)}else{for(h=c.length+2;0<=(h=c.lastIndexOf(".",h-2))&&!(g=C["@"+c.substring(0,h)]););d||(c=c.replace(/\./g,"/"))}null==g&&(g=window.Clazz&&a.binaryFolders&&a.binaryFolders.length?a.binaryFolders[0]:b.binaryFolders&&b.binaryFolders.length?b.binaryFolders[0]:"j2s");f=(g.lastIndexOf("/")==g.length-1?g:g+"/")+(d?"":c.lastIndexOf("/*")==c.length-2?c.substring(0,h+1):c+(!e?".js":"."!=e.charAt(0)?"."+e:e))}return f};b.ignore=
function(){var a=1==arguments.length&&arguments[0]instanceof Array?a=arguments[0]:null,b=a?a.length:arguments.length;if(!a)for(var a=Array(b),c=0;c<b;c++)a[c]=arguments[c];v(a);for(c=0;c<b;c++)z["@"+a[c]]=1};b.onScriptLoading=function(){};b.onScriptLoaded=function(){};b.onScriptInitialized=function(){};b.onScriptCompleted=function(){};b.onClassUnloaded=function(){};b.onGlobalLoaded=function(){};b.keepOnLoading=!0;var x={},z={},L=function(c,d,e,f){if(!f)try{eval(e+";//# sourceURL="+c)}catch(g){if(a._isQuiet)return;
c="[Java2Script] The required class file \n\n"+c+(0==e.indexOf("[Exception")&&e.indexOf("data: no")?"\nwas not found.\n":"\ncould not be loaded. Script error: "+g.message+" \n\ndata:\n\n"+e)+"\n\n"+a.getStackTrace();alert(c);a.alert(c);throw g;}b.onScriptLoaded(c,!1);W(d)},M=function(a){return function(){if("interactive"!=a.readyState){try{a.parentNode&&a.parentNode.removeChild(a)}catch(b){}a=null}}},K=function(a){window["j2s.script.debugging"]||window.setTimeout(M(a),1)};a._4Name=function(c,d,e){if(a.isClassDefined(c))return a.evalType(c);
d=j._isAsync&&d?d._restoreState(c,e):null;if(1==d)return null;if(b.setLoadingMode(d?b.MODE_SCRIPT:"xhr.sync"))return b.loadClass(c,d,!1,!0,1),null;b.loadClass(c);return a.evalType(c)};a.currentPath="";var G=function(c,d,g,h,k){a.currentPath=d;h&&alert("WHY>>");h=e[d];e[d]=!0;ka(w,d);ga=!0;ha=!1;b._checkLoad&&System.out.println("\t"+d+(g?"\n -- required by "+g:"")+"  ajax="+ga+" async="+ha);g=d;a._debugging&&(d=d.replace(/\.z\.js/,".js"));h||System.out.println("loadScript "+d);b.onScriptLoading(d);
if(ga&&!ha){var l=j._getFileData(d);try{L(d,g,l,h)}catch(m){alert(m+" loading file "+d+" "+c.name+" "+a.getStackTrace())}k&&k()}else c={dataType:"script",async:!0,type:"GET",url:d,success:N(d,!1,k),error:N(d,!0,k)},f++,h?setTimeout(c.success,0):j.$ajax(c)},N=function(c,d,e){a.getStackTrace();return function(){m&&this.timeoutHandle&&(window.clearTimeout(this.timeoutHandle),this.timeoutHandle=null);0<f&&f--;this.onerror=this.onload=null;d&&alert("There was a problem loading "+c);b.onScriptLoaded(c,
!0);var a=this,g;g=e?function(){K(a);W(c,e)}:function(){K(a);W(c)};0<=na?window.setTimeout(function(){W(c,g)},na):W(c,g)}},I=!0,O=!1,W=function(c,h){var j=x["@"+c];if(j){var k,m=C["$"+c];if(m)for(var q=0;q<m.length;q++){var t=m[q];if(t!=j.name&&(k=D(t)))k.status<n.STATUS_CONTENT_LOADED&&(k.status=n.STATUS_CONTENT_LOADED,updateNode(k));else{k=new n;k.name=t;var p=C["#"+t];p||(alert(t+" J2S error in tryToLoadNext"),error("Java2Script implementation error! Please report this bug!"));k.path=p;fa(k.path,
t,k);k.status=n.STATUS_CONTENT_LOADED;ba(d,k,!1);updateNode(k)}}if(j instanceof Array)for(q=0;q<j.length;q++)j[q].status<n.STATUS_CONTENT_LOADED&&(j[q].status=n.STATUS_CONTENT_LOADED,updateNode(j[q]));else if(j.status<n.STATUS_CONTENT_LOADED){k=!1;m=document.getElementsByTagName("SCRIPT");for(q=0;q<m.length;q++)if(l){if(m[q].onreadystatechange&&m[q].onreadystatechange.path==j.path&&"interactive"==m[q].readyState){k=!0;break}}else if(m[q].onload&&m[q].onload.path==j.path){k=!0;break}k||(j.status=n.STATUS_CONTENT_LOADED,
updateNode(j))}if(b.keepOnLoading){q=!0;if(k=oa(n.STATUS_KNOWN))for(ia(k);f<g&&(k=oa(n.STATUS_KNOWN));)ia(k);else if(0!=w.length)k=w.shift(),!e[k.path]||0!=w.length||!I||k.musts.length||k.optionals.length?(ba(d,k,!0),G(k,k.path,k.requiredBy,!1)):I&&(I=!1);else if(k=pa(n.STATUS_KNOWN))for(ia(k);f<g&&(k=pa(n.STATUS_KNOWN));)ia(k);else q=!1;if(!(q||0<f)){j=[oa,pa];m=null;for(q=0;2>q;q++)for(;k=j[q](n.STATUS_CONTENT_LOADED);)1==q&&m===k&&(k.status=n.STATUS_LOAD_COMPLETE),updateNode(k),m=k;for(;!(P=[],
!R(d,c)););for(q=0;2>q;q++)for(m=null;(k=j[q](n.STATUS_DECLARED))&&m!==k;)updateNode(m=k);m=[];for(q=0;2>q;q++)for(;k=j[q](n.STATUS_DECLARED);)m.push(k),k.status=n.STATUS_LOAD_COMPLETE;if(m.length){for(q=0;q<m.length;q++)Q(m[q]);for(q=0;q<m.length;q++)if(j=m[q].onLoaded)m[q].onLoaded=null,j()}if(h)h();else if(b._classCountPending)for(t in b._classPending){if(k=D(t),System.out.println("class left pending "+t+" "+k),k){updateNode(k);break}}else b._checkLoad&&(System.out.println("I think I'm done: SAEM call count: "+
r),a.showDuplicates(!0));b.onGlobalLoaded()}}}},P=[],R=function(a,c){var d=P,e=d.length;d.push(a);for(var f=e;0<=--f&&!(d[f]===a&&d[f].status>=n.STATUS_DECLARED););if(0<=f){if(b._checkLoad){var g;System.out.println("cycle found loading "+c+" for "+a)}for(;f<e;f++){var h=d[f];h.status=n.STATUS_LOAD_COMPLETE;Q(h);for(g=0;g<h.parents.length;g++)updateNode(h.parents[g]);h.parents=[];var j=h.onLoaded;b._checkLoad&&(g="cycle setting status to LOAD_COMPLETE for "+h.name+(j?" firing "+j.toString():""),System.out.println(g));
j&&(h.onLoaded=null,j())}d.length=0;return!0}h=[a.musts,a.optionals];for(g=0;2>g;g++){j=h[g];for(f=j.length;0<=--f;)if(j[f].status==n.STATUS_DECLARED&&R(j[f],c))return!0}d.length=e;return!1};b._classCountPending=0;b._classCountOK=0;b._classPending={};b.showPending=function(){var a=[],c;for(c in b._classPending){var d=D(c);d?(a.push(d),System.out.println(S("","",d,"",0))):alert("No node for "+c)}return a};var S=function(a,b,c,d,e){b+="--"+c.name;a+=b+"\n";if(5<e)return a+(d+" ...\n");d+="\t";a+=d+
"status: "+c.status+"\n";if(c.parents&&c.parents.length&&c.parents[0]&&c.parents[0].name){a+=d+"parents: "+c.parents.length+"\n";for(var f=0;f<c.parents.length;f++)a=S(a,b,c.parents[f],d+"\t",e+1);a+="\n"}return a};updateNode=function(a){if(!a.name||a.status>=n.STATUS_LOAD_COMPLETE)Q(a);else{var c=!0;if(a.musts.length&&a.declaration)for(var d=a.musts.length,e=d;0<=--e;){var f=a.musts[e];f.requiredBy=a;if(f.status<n.STATUS_DECLARED&&isClassDefined(f.name)){var g=[];f.status=n.STATUS_LOAD_COMPLETE;
Q(f);if(f.declaration&&f.declaration.clazzList){for(var h=0,j=f.declaration.clazzList,k=j.length;h<k;h++){var l=D(j[h]);l&&(l.status!=n.STATUS_LOAD_COMPLETE&&l!==f)&&(l.status=f.status,l.declaration=null,Q(l),l.onLoaded&&g.push(l))}f.declaration=null}f.onLoaded&&g.push(f);for(h=0;h<g.length;h++)if(j=g[h].onLoaded)g[h].onLoaded=null,j()}else f.status==n.STATUS_CONTENT_LOADED&&updateNode(f),f.status<n.STATUS_DECLARED&&(c=!1);a.musts.length!=d&&(e=d=a.musts.length,c=!0)}if(c){if(a.status<n.STATUS_DECLARED){if(e=
a.declaration)e(),e.executed=!0;b._checkLoad&&b._classPending[a.name]&&(delete b._classPending[a.name],b._classCountOK,b._classCountPending--);a.status=n.STATUS_DECLARED;u&&(u[a.name]=!0);b.onScriptInitialized(a.path);if(a.declaration&&a.declaration.clazzList){h=0;j=a.declaration.clazzList;for(k=j.length;h<k;h++)if((l=D(j[h]))&&l.status!=n.STATUS_DECLARED&&l!==a)l.status=n.STATUS_DECLARED,u&&(u[l.name]=!0),b.onScriptInitialized(l.path)}}c=n.STATUS_DECLARED;if(0==a.optionals.length&&0==a.musts.length||
a.status>n.STATUS_KNOWN&&!a.declaration||T(a.musts,n.STATUS_LOAD_COMPLETE)&&T(a.optionals,n.STATUS_LOAD_COMPLETE)){c=n.STATUS_LOAD_COMPLETE;if(!U(a,c))return!1;if(a.declaration&&a.declaration.clazzList){h=0;j=a.declaration.clazzList;for(k=j.length;h<k;h++)if((l=D(j[h]))&&l.status!=c&&l!==a)if(l.declaration=null,!U(l,c))return!1}}if(a.parents&&a.parents.length){for(e=0;e<a.parents.length;e++)h=a.parents[e],h.status<c&&updateNode(h,h.name);c==n.STATUS_LOAD_COMPLETE&&(a.parents=[])}}}};var T=function(a,
b){for(var c=a.length;0<=--c;)if(a[c].status<b)return!1;return!0},U=function(a,c){a.status=c;b.onScriptCompleted(a.path);var d=a.onLoaded;if(d&&(a.onLoaded=null,d(),!b.keepOnLoading))return!1;Q(a);return!0},V={"r0.13412":1},X=function(){for(;;){var a=Math.random(),b="r"+a;if(!V[b])return V[b]=1,d.random=a}},D=function(a){X();return Y(a,d)},pa=function(a){X();return ca(d,a)},oa=function(a){return aa(d,a)},Y=function(a,b){var c;return b.name==a?b:(c=Z(a,b.musts))||(c=Z(a,b.optionals))?c:null},Z=function(a,
b){for(var c=d.random,e=b.length;0<=--e;){var f=b[e];if(f.name==a||f.random!=c&&(f.random=c,f=Y(a,f)))return f}return null},ja=function(a,b){return a.status==b&&(b!=n.STATUS_KNOWN||!e[a.path])&&(b==n.STATUS_DECLARED||!isClassDefined(a.name))},aa=function(a,b){for(var c=a.musts.length;0<=--c;){var d=a.musts[c];if(ja(d,b)||(d=aa(d,b)))return d}return ja(a,b)?a:null},ca=function(a,b){var c;return(c=da(a.musts,b))||(c=da(a.optionals,b))||ja(c=a,b)?c:null},da=function(a,b){if(a)for(var c=d.random,e=0;e<
a.length;e++){var f=a[e];if(ja(f,b)||f.random!=c&&(f.random=c,f=ca(f,b)))return f}return null},qa=function(a,c,e,f){if(c instanceof Array){v(c);for(var g=0;g<c.length;g++)qa(a,c[g],e,f,c)}else{b._checkLoad&&!b._classPending[c]&&(b._classPending[c]=1,0==b._classCountPending++&&(b._classCountOK=0),System.out.println("Loading class "+c));g=x["#"+c];g||(g=(g=D(c))?g:new n,g.name=c,g.path=C["#"+c]||"unknown",fa(g.path,c,g),g.status=n.STATUS_KNOWN,ba(d,g,!1));ea(g,a,!0);5==arguments.length&&f&&(f.status=
g.status,f.clazzList=arguments[4]);if(g.declaration=f)g.status=n.STATUS_CONTENT_LOADED;ea(g,e,!1)}},ea=function(a,b,c){if(b&&b.length){v(b);for(var d=0;d<b.length;d++){var e=b[d];if(e&&!isClassDefined(e)&&!z["@"+e]){var f=D(e);f||(f=new n,f.name=e,f.status=n.STATUS_KNOWN);f.requiredBy=a;ba(a,f,c)}}}};window.Clazz?a.load=qa:b.load=qa;var fa=function(a,b,c){var d="@"+a;if(a=x[d])if(a instanceof Array){for(var d=!1,e=0;e<a.length;e++)if(a[e].name==b){d=!0;break}d||a.push(c)}else x[d]=[a,c];else x[d]=
c;x["#"+b]=c},ia=function(a){var c=a.name;if(!isClassDefined(c)&&!z["@"+c]){var d=b.getClasspathFor(c);a.path=d;fa(d,c,a);if(!e[d])return G(a,d,a.requiredBy,!1),!0}return!1},la=b.runtimeKeyClass="java.lang.String",ma=[];b.getJ2SLibBase=function(){var a=window["j2s.lib"];return a?a.base+("."==a.alias?"":(a.alias?a.alias:a.version?a.version:"1.0.0")+"/"):null};var ha=!0,ga=!1,na=-1;b.MODE_SCRIPT=4;b.MODE_XHR=2;b.MODE_SYNC=1;b.setLoadingMode=function(a,c){var d=!0,e=!0;"string"==typeof a?(a=a.toLowerCase(),
0<=a.indexOf("script")?e=!1:a.indexOf("async"),d=!1):a&b.MODE_SCRIPT?e=!1:d=!(a&b.MODE_SYNC);ga=e;na=(ha=d)&&0<=c?c:-1;return d};var ta=function(){if(!y&&isClassDefined(la)){for(var a=ma,c=0;c<a.length;c++)b.loadClass(a[c][0],a[c][1]);ma=[]}};b.loadZJar=function(a,c){var d=null,e=c instanceof Array;e?c=c[c.length-1]:d=c==la?ta:null;b.jarClasspath(a,e?c:[c]);b.loadClass(c,d,!0)};var ua={},ra=[],ba=function(a,b,c){var e=!1;c?(c=a.musts,b.requiredBy||(b.requiredBy=a)):c=a.optionals;ua[b.name]||(ra.push(b),
ua[b.name]=b);for(var f=0;f<c.length;f++)if(c[f].name==b.name){e=!0;break}e||(c.push(b),I&&(0!=b.name.indexOf("java")&&0!=b.name.indexOf("net.sf.j2s.ajax"))&&(O&&(I=!1),O=!0));a:{if(a.name&&a!=d&&a!=b)for(e=0;e<b.parents.length;e++)if(b.parents[e].name==a.name)break a;b.parents.push(a)}},Q=function(a){var b=a.parents;if(b)for(var c=b.length;0<=--c;)ka(b[c].musts,a)||ka(b[c].optionals,a)};a.binaryFolders=b.binaryFolders=[b.getJ2SLibBase()]})(a,a._Loader);a._LoaderProgressMonitor={};var x=a._LoaderProgressMonitor,
G=null,L=0,v=null,R=0;x.DEFAULT_OPACITY=j&&j._j2sLoadMonitorOpacity?j._j2sLoadMonitorOpacity:55;x.hideMonitor=function(){v.style.display="none"};x.showStatus=function(a,b){if(!v){var c=document.createElement("DIV");c.id="_Loader-status";c.style.cssText="position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:"+(window["j2s.lib"].monitorZIndex||1E4)+";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";c.onmouseover=ra;v=c;document.body.appendChild(c);
ca||(ca=!0)}da(v);if(null==a)b?N():x.hideMonitor();else{v.appendChild(document.createTextNode(""+a));"none"==v.style.display&&(v.style.display="");ea(x.DEFAULT_OPACITY);var d,c=navigator.userAgent;d=document.body;var e=d.parentNode,f=e.clientHeight;d=d.scrollTop+d.offsetTop;var g=e.scrollTop+e.offsetTop,c=0>c.indexOf("Opera")&&document.all?0==f?d:g:0>c.indexOf("Gecko")?f==e.offsetHeight&&f==e.scrollHeight?d:g:d;R!=c&&(R=c,v.style.bottom=R+4+"px");b&&N()}};var da=function(a){if(a)for(var b=a.childNodes.length;0<=
--b;){var c=a.childNodes[b];if(c){c.childNodes&&c.childNodes.length&&da(c);try{a.removeChild(c)}catch(d){}}}},ea=function(a){G&&a==x.DEFAULT_OPACITY&&(window.clearTimeout(G),G=null);L=a;navigator.userAgent.toLowerCase();v.style.filter="Alpha(Opacity="+a+")";v.style.opacity=a/100},ra=function(){x.hideMonitor()},ca=!1,N=function(){"none"!=v.style.display&&(L==x.DEFAULT_OPACITY?(G=window.setTimeout(function(){N()},750),L-=5):0<=L-10?(ea(L-10),G=window.setTimeout(function(){N()},40)):v.style.display=
"none")},p=a.Console,y=System;p.maxTotalLines=1E4;p.setMaxTotalLines=function(a){p.maxTotalLines=0<a?a:999999};p.maxLatency=40;p.setMaxLatency=function(a){p.maxLatency=0<a?a:40};p.pinning=!1;p.enablePinning=function(a){p.pinning=a};p.linesCount=0;p.metLineBreak=!1;p.createConsoleWindow=function(){var a=document.createElement("DIV");a.style.cssText="font-family:monospace, Arial, sans-serif;";document.body.appendChild(a);return a};var z=String.fromCharCode(160),z=z+(z+z+z);p.consoleOutput=function(a,
b){var c=window["j2s.lib"];(c=c&&c.console)&&"string"==typeof c&&(c=document.getElementById(c));if(!c)return!1;if(p.linesCount>p.maxTotalLines){for(var d=0;d<p.linesCount-p.maxTotalLines;d++)c&&0<c.childNodes.length&&c.removeChild(c.childNodes[0]);p.linesCount=p.maxTotalLines}var e=!1;a=("undefined"==typeof a?"":null==a?"null":""+a).replace(/\t/g,z);if(0<a.length)switch(a.charAt(a.length-1)){case "\n":case "\r":a=1<a.length?a.substring(0,a.length-("\r"==a.charAt(a.length-2)?2:1)):"",e=!0}var f=null;
a=a.replace(/\t/g,z);for(var f=a.split(/\r\n|\r|\n/g),d=0,g=f.length-1;d<=g;d++){var h=null;if(p.metLineBreak||0==p.linesCount||1>c.childNodes.length)h=document.createElement("DIV"),c.appendChild(h),h.style.whiteSpace="nowrap",p.linesCount++;else try{h=c.childNodes[c.childNodes.length-1]}catch(j){h=document.createElement("DIV"),c.appendChild(h),h.style.whiteSpace="nowrap",p.linesCount++}var k=document.createElement("SPAN");h.appendChild(k);k.style.whiteSpace="nowrap";b&&(k.style.color=b);h=f[d];0==
h.length&&(h=z);k.appendChild(document.createTextNode(h));p.pinning||(c.scrollTop+=100);p.metLineBreak=d!=g||e}d=c.parentNode.className;!p.pinning&&(d&&-1!=d.indexOf("composite"))&&(c.parentNode.scrollTop=c.parentNode.scrollHeight);p.lastOutputTime=(new Date).getTime()};p.clear=function(){try{p.metLineBreak=!0;var a=window["j2s.lib"],b=a&&a.console;if(b&&(b=document.getElementById(b))){for(var c=b.childNodes,d=c.length;0<=--d;)b.removeChild(c[d]);p.linesCount=0}}catch(e){}};a.alert=function(a){p.consoleOutput(a+
"\r\n");j.clazzAlert(a)};y.out.print=function(a){p.consoleOutput(a)};y.out.println=function(a){p.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n")};y.out.write=function(a,b,c){y.out.print(String.instantialize(a).substring(b,b+c))};y.err.__CLASS_NAME__="java.io.PrintStream";y.err.print=function(a){p.consoleOutput(a,"red")};y.err.println=function(a){p.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};y.err.write=function(a,b,c){y.err.print(String.instantialize(a).substring(b,
b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2023-11-22 23:54:28 -0600 (Wed, 22 Nov 2023) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="16.1.47";
